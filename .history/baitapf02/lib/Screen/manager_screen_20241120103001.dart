          ...
          Expanded(
            child: GridView.builder(
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 2, // Hiển thị 2 cột trên màn hình Android
                crossAxisSpacing: 10, // Tăng khoảng cách giữa các cột
                mainAxisSpacing: 10, // Tăng khoảng cách giữa các hàng
                childAspectRatio: 1, // Tỉ lệ chiều rộng:chiều cao cho mỗi mục
              ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(icon,
                size: 40, color: Colors.deepPurple), // Tăng kích thước icon
            SizedBox(height: 5),
            Text(
              label,
              style: TextStyle(
                fontSize: 14, // Kích thước chữ nhỏ hơn cho Android
...
final _items = [
  {'icon': Icons.person, 'label': 'User', 'route': null},
  {'icon': Icons.book, 'label': 'Product', 'route': null},
  {'icon': Icons.person_outline, 'label': 'Author', 'route': null},
  {'icon': Icons.library_books, 'label': 'Publisher', 'route': null},
  {'icon': Icons.shopping_cart, 'label': 'Order', 'route': null},
  {'icon': Icons.category, 'label': 'Category', 'route': '/category'},
];
