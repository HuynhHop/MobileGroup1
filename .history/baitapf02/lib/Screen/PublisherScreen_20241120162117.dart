      ...
      if (response.statusCode == 200) {
        ...
        if (data["success"]) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text("Failed to fetch publishers")),
          );
        }
      } else {
        setState(() => isLoading = false);
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              if (result == true) {
                fetchPublishers(); // Làm mới danh sách nếu thêm thành công
              }
            },
          ),
        ],
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () async {
                                ...
                                if (result == true) {
                                  fetchPublishers(); // Làm mới danh sách nếu cập nhật thành công
                                }
                              },
                            ),
                            IconButton(
                              ...
                              onPressed: () {
                                confirmDelete(publisher['_id'].toString(),
                                    publisher['name']);
                              },
                            ),
                          ],
